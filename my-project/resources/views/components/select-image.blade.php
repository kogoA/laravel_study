...
<div class="modal micromodal-slide" id="{{ $modal }}" aria-hidden="true">
            ...
            <div class="flex flex-wrap" >
                ...
                <div class="w-1/4 p-2 md:p-4">
                        <div class="border rounded-md p-4">
                            ...
                            <div>
                                <img class="image" data-id="{{ $name }}_{{ $image->id }}" data-file="{{ $image->filename }}" data-path="{{ asset('storage/products/') }}"
  ...
  <div class="flex justify-around items-center mb-4">
    <a class="py-2 p-4 bg-gray-200" data-micromodal-trigger="{{ $modal }}" href='javascript:;'>ファイルを選択</a>
    <div class="w-1/4">
