<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-centere">
                    ...
                    <div class="flex">
                        <div>
                            ...
                            <select id="sort" name="sort" class="mr-4">
                                ...
                                <option value="{{ \Constant::SORT_ORDER['lowerPrice']}}"  @if(\Request::get('sort') === \Constant::SORT_ORDER['lowerPrice'])  selected @endif>金額の安い順</option>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    {{ $products->appends([
                        ...
                        'pagenation' => \Request::get('paginationo')
                    ])->links()}}
                </div>
            </div>
        </div>
