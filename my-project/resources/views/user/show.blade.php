        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="md:w-1/2">
                            ...
                            <div class="swiper">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide"><img src="{{ asset('storage/products/sample2.jpg')}}"></div>
                    ...
                    <div class="border-t border-gray400">
                        ...
                        <div class="mb-4 text-center">
                            <button type="button" data-micromodal-trigger="modal-1" href='javescript:;' class="flex ml-auto text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">ショップの詳細を見る</button>
                        </div>
                    </div>
                </div>
            </div>
